...
static int chat_lane_run(runtime_ctx *ctx, const char *session_id, int64_t task_id, int thinking_mode, const char *prompt,
                          char **answer) {
    ...
    reasoning_set_thinking_mode(ctx->chat_lanes[lane], thinking_mode);
